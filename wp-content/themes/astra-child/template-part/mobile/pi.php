...
<div class="pi-box-material box-material" id="pi-material-<?php echo $pipost->ID; ?>" data-id="<?php echo $pipost->ID; ?>"
     data-lead_time_option="<?php echo $lead_time_options; ?>" data-density="<?php echo $density; ?>"
     data-coefficient_1="<?php echo $coefficient_1; ?>" data-coefficient_2="<?php echo $coefficient_2; ?>"
     data-coefficient_3="<?php echo $coefficient_3; ?>" data-coefficient_4="<?php echo $coefficient_4; ?>"
     data-surface_treatment="<?php echo $surface_treatment; ?>" data-finishingcoating="<?php echo $finishingcoating; ?>"
...
>
    <!-- <div class="pi-material-box-desc-service">Plastic Injection Molding</div> -->
    <?php $thumb_id = get_post_thumbnail_id($pipost->ID);
        $thumb_url = wp_get_attachment_image_src($thumb_id, "thumbnail-size", true); ?>
    <div class="pi-box-material-materiallist">

        <div class="pi-material-box-desc-thumbnail">
            <div class="three_zoom"></div>
            <input type="hidden" class="three_product" name="three_product" value="<?php echo $thumb_url[0]; ?>"/>
            <img src="<?php echo get_the_post_thumbnail_url($pipost->ID, array(80, 80), array('alt' => '')); ?>" />
        </div>
        <div class=" pi-material-box-desc-properties material-item-overflow pi-column-material">
            <div class="pi-material-title material-part">
            ...
            <span class="pi-file-mould-part-wrap">
                <span class="pi-finish-qty-head">
                    <span class="select-finishing pi-select-finish-name"></span>
                    <span class="pi-file-quantity-wrap pi-files-all-qt"></span>
                </span>
            </span>
            <!-- <div class="pi-material-fullname"><?php if ($full_name) {
                echo '(' . $full_name . ')';
            } ?></div> -->
        </div>
        <!-- <td class="fixed-table-1"><?php //echo $color; ?></td> -->
        <div class="pi-material-box-desc-leadtime pi-column-leadtime printing-select-lead-time"><?php echo $lead_time_text; ?></div>
        <div class="pi-material-box-desc-price pi-column-price">
            <div>$<span class="pi-material-price material-price"><?php echo '0.00' ?></span></div>
        </div>
        <!--        <div class="custom-pi-column-width-4 pi-material-box-desc-cart pi-column-cart">-->
        <div class="" title="Add to cart"><span class="pi-add-to-cart-button"><svg
        ...
        <div class="show-files-arrow-wrap"><span class="show-files-arrow pi-show-files-arrow"><i
                        class="fa-solid fa-angle-<?php if ($dcount == 0) {
                            echo 'up';
                        } else {
                            echo 'down';
                        } ?>"></i></span></div>
    ...
    <div class="pi-files-container files-box pi-material-<?php echo $pipost->ID; ?>" style="<?php if ($dcount == 0) {
        echo 'display: block;';
    } else {
        echo 'display: none;';
    } ?>"></div>
