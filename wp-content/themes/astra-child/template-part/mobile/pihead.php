...
<div class="pi-materials-select-outer-container xia-table-materials-select-outer-container" id="pi-container">
			<div class="our-service-name-wrap">
				<div class="our-service-name">
					<div style="display: flex;align-items: center;">
				    <span class="pi-fa-angles-wrap fa-angles-wrap">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon/molding.png">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon/molding.png">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/icon/molding.png">

<!--				        <span class="open"><img src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/img/icon/molding.png"></span>-->
<!--				        <span class="close"><img src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/img/icon/molding_without words.png"></span>-->
				    </span>
<!--				    <span class="moding_text">Plastic Molding<br>(Injection, Blowing, Extruding, Rotation)</span>-->
					</div>

                    <div class="moding_text">
                        <div>Plastic</div>
                        <div>Molding</div>
                    </div>
                    ...
                    <div class="full-screen-wrap">
                        ...
                        <div>
                            <svg t="1674834683966" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2776" width="32" height="32"><path d="M1024 0 1024 384 885.728 245.728 673.728 457.728 566.272 350.272 778.272 138.272 640 0ZM245.728 138.272 457.728 350.272 350.272 457.728 138.272 245.728 0 384 0 0 384 0ZM885.728 778.272 1024 640 1024 1024 640 1024 778.272 885.728 566.272 673.728 673.728 566.272ZM457.728 673.728 245.728 885.728 384 1024 0 1024 0 640 138.272 778.272 350.272 566.272Z" fill="#8d3a56" p-id="2777"></path></svg>
                        </div>
                        <div>
...
<!--				    <span class="pi-fa-angles-wrap fa-angles-wrap">-->
<!--				        <span class="open"><img src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/img/printing_unfold.png"></span>-->
<!--				        <span class="close"><img src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/img/printing_fold.png"></span>-->
<!--				    </span>-->
				</div>
			</div>
		<div class="pi-materials-select-inner-container">
			<div class="pi-material-box-head-name fix-head material-box-head-name">
                <div class="printing-column-swatch"><span class="head-title-top">Material</span><br>Part Name</div>
                <div class="printing-column-swatch"><span class="head-title-top">Color</span><br>Finish</div>
                <div class="printing-column-swatch">Lead Times</div>
                <div class="printing-column-swatch"><span class="head-title-top">Mould Qty</span><br>Part Qty</div>
...
<!--				<div class="custom-pi-column-width-1 pi-column-swatch">Swatch<br>/Image</div>-->
<!--				<div class="custom-pi-column-width-2 pi-material-box-head-material material-item-overflow">-->
<!--					<span class="material-part icon-paixu iconfont pi-column-material">Material<br>/Part</span>-->
<!--					<span class="pi-file-mould-part-wrap">-->
<!--                        <span class="pi-finish-qty-head">-->
<!--                            <span class="select-finishing pi-column-finish">Finish</span>-->
<!--                            <span class="pi-file-quantity-wrap pi-column-qty">Q'ty</span>-->
<!--                        </span>-->
<!--                    </span>-->
<!--				</div>-->
<!--                <div class="custom-pi-column-width-3 pi-material-box-head-leadtime pi-column-lead_time">Leadtime</div>-->
<!--                <div class="custom-pi-column-width-3 pi-material-box-head-price icon-paixu iconfont pi-column-price">Price</div>-->
<!--                <div class="custom-pi-column-width-4 pi-material-box-head-cart pi-column-cart">Cart</div>-->
			</div>