...
<main id="main" class="site-main">
	...
	<div id="drop" class="dropBox_wrap">
		<div id="dropbox" class="drop">
		    <p class="drop-upload-placehoder">Upload files or drag and drop here</p>
					...
					<div class="upload-btn-file-info-contianer">
						...
						<div class="file-info-wrap">
							...
							<div class="file-info-volume-wrap">
								<label class="file-info-label">Volume: </label><span class="file-info-volume">0</span><span class="file-info-unit">mm</span><sup>3</sup>
							</div>
							<div class="file-info-surface-wrap">
								<label class="file-info-label">Surface: </label><span class="file-info-surface">0</span><span class="file-info-unit">mm</span><sup>2</sup>
							</div>
						</div>
					</div>
					<div class="clear-all-file-unit-container">
						...
						<div class="file-unit-wrap">
							<form class="file-unit-option">
								<label class="file-unit-label   checked">
									<input id="file_unit" type="radio" name="file_unit" value="mm"   checked="checked"><span class="file-unit">mm</span><i></i>
								</label>
								<label class="file-unit-label">
									<input id="file_unit" type="radio" name="file_unit" value="inch"><span class="file-unit">inch</span><i></i>
								</label>
							</form>
						</div>
					</div>
