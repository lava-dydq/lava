...
// one content
?>
<div class="box-material" id="material-<?php echo $post->ID; ?>"
     data-id="<?php echo $post->ID; ?>"
     data-price_item="<?php echo $price; ?>"
     data-is_painting="<?php echo $painting; ?>"
     data-price_painting="<?php echo $price_painting; ?>"
     data-is_screen="<?php echo $silk_screen; ?>"
     ...
     data-fixed_cofficient="<?php echo $fixed_cofficient ?>"
     data-weight_range_1="<?php echo $weight_range_1 ?>"
     data-weight_range_2="<?php echo $weight_range_2 ?>"
     ...
     data-usdrmb_exchange_rate="<?php echo $usdrmb_exchange_rate ?>"
     data-floor_price="<?php echo $floor_price ?>"
     data-material_process="<?php echo $material_process ?>">

    <div class="box-material-materiallist mater-scorll">
        <?php
        ...
        $p8_url = $thumb_url[0];
        ?>
        <div class="custom-column-width-1 ma-material-box-desc-thumbnail base-drawing printing-column-swatch">
            <div id="one_zoom" class="one_zoom"></div>
            <input type="hidden" class="one_product" data-zoom="<?php echo $p8_url; ?>"
                   data-url="<?php echo get_the_permalink($post->ID); ?>" name="one_product"
                   value="<?php echo $p_url; ?>"/>

            <div class="ma-box"><?php echo get_the_post_thumbnail($post->ID, array(80, 80), array('alt' => 'CNC Machining Material ' . get_the_title())); ?></div>

        </div>
        <div class="custom-column-width-1 printing-material-process printing-column-process"><?php echo $material_process; ?></div>
<!--        <div class="custom-column-width-2 material-box-desc-properties material-item-overflow">-->
            ...
            <div class="ma-material-title material-part printing-column-material">
                ...
                <span data-toggle="tooltip" data-placement="auto"
                      title="<?php echo get_post_meta($post->ID, 'material_explain', 1); ?>" data-trigger="hover">
...
<!--            <span class="material-file-options-qty-wrap">-->
							...
							<span class="select-lead-time printing-select-lead-time printing-column-lead_time"><?php echo $leadtime_text ?></span>
							<span class="col-quantity printing-files-all-qty printing-column-qty"></span>
                            <span class="uni-price printing-column-unit"></span>
<!--            </span>-->

<!--        </div>-->
        <div class="custom-column-width-3 material-box-desc-price printing-column-price">
            <div>US$ <span class="material-price"><?php echo '0.00'; ?></span></div>

        </div>
        <div class="printing-column-cart">
            <div class="add-to-cart-warp" title="Add to cart">
                <span class="add-to-cart-button"><svg t="1655729930116"
                                                                                                    class="icon"
                                ...
                                fill="#2c2c2c" p-id="5308"></path></svg></span>
            </div>
        </div>
