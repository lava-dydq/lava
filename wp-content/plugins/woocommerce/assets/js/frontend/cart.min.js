    ...
    var r = function (t) {
        ...
        o = function (t, e) {
            ...
            if (0 === n(".woocommerce-cart-form").length) 
                ...
                if (e || n(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), 0 === i.length) {
                    ...
                    n(".woocommerce-cart-form__contents").closest(".woocommerce").replaceWith(e),
                    0 < a.length && u(a),
                    ...
                    n(".woocommerce-cart-form").find(':input[name="update_cart"]').prop("disabled", !0).attr("aria-disabled", !0),
                    0 < a.length && u(a),
                    p(r);
        ...
        t = {
            init: function () {
                ...
                n(document).on("change input", ".woocommerce-cart-form .cart_item :input", this.input_changed),
                n('.woocommerce-cart-form :input[name="update_cart"]').prop("disabled", !0).attr("aria-disabled", !0)
            },
            ...
            cart_submit: function (t) {
                var e = n(document.activeElement),
                    ...
                    c = n(t.currentTarget);
                if (0 !== (c = c.is("form") ? c : n(t.currentTarget).parents("form")).find(".woocommerce-cart-form__contents").length) 
                    return ! i(c) && void(o.is(':input[name="update_cart"]') || e.is("input.qty") ? (t.preventDefault(), this.quantity_update(c)) : (o.is(':input[name="apply_coupon"]') || e.is("#coupon_code")) && (t.preventDefault(), this.apply_coupon(c)))
